window.Thunder.setMessages({
	...
	'order-detail': {
		...
		itemPrice:                       '가격',
		itemOption:                      '상품 옵션',
		downloadButton:                  '파일 다운 받기',
		downloadCountView:               '총 %{current}/%{total}회 다운',
		downloadExpiresAtView:           '%{year}년 %{month}월 %{date}일 %{hours}시까지 다운가능',
		downloadExpiresDaysView:         '결제 완료 시점부터 %{value}일 간 다운 가능 ',
		downloadExpiresWeeksView:        '결제 완료 시점부터 %{value}주 간 다운 가능 ',
		downloadExpiresMonthsView:       '결제 완료 시점부터 %{value}달 간 다운 가능 ',
		downloadExpiresYearsView:        '결제 완료 시점부터 %{value}년 간 다운 가능 ',
		fullyUsedItem:                   '다운로드 가능 횟수를 초과했습니다.',
		expiredItem:                     '다운로드 기간이 만료되었습니다.',
		refundedItem:                    '환불되었거나 환불중인 상품은 다운로드가 불가능합니다',
		shippingMethod:                  '배송 방식',
		appliedCoupon:                   '적용 쿠폰',
