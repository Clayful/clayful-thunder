(function() {
	...
	var messages = {
		...
		'product-detail': {
			...
			unavailableSelection:              '선택된 상품은 구매가 불가능합니다.',
			soldOutSelection:                  '선택된 상품은 품절되었습니다.',
			goToCart:                          '카트로 가기',
			buyNow:                            '바로 구매',
			unavailableProduct:                '구매 불가 상품',
			soldOutProduct:                    '품절 상품',
		...
		'order-detail': {
			...
			itemPrice:                       '가격',
			itemOption:                      '상품 옵션',
			downloadFile:                    '파일 다운 받기',
			nTimesDownloaded:                '총 %{current}/%{total}회 다운됨',
			downloadExpiresAt:               '%{year}년 %{month}월 %{date}일 %{hours}시까지 다운 가능',
			fullyUsedDownloadable:           '다운로드 가능 횟수를 초과했습니다.',
			expiredDownloadable:             '다운로드 기간이 만료되었습니다.',
			refundedItem:                    '환불 처리 중이거나 환불 완료된 상품입니다.',
			shippingMethod:                  '배송 방식',
			appliedCoupon:                   '적용 쿠폰',
