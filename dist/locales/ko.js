(function() {
	...
	var messages = {
		...
		'order-detail': {
			...
			downloadCountView:               '총 %{current}/%{total}회 다운됨',
			downloadExpiresAtView:           '%{year}년 %{month}월 %{date}일 %{hours}시까지 다운 가능',
			fullyUsedItem:                   '다운로드 가능횟수를 초과했습니다.',
			expiredItem:                     '다운로드 기간이 만료되었습니다',
			refundedItem:                    '환불 처리중이거나 환불 완료된 상품입니다.',
			shippingMethod:                  '배송 방식',
			appliedCoupon:                   '적용 쿠폰',
